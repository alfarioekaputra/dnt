...
/**
 * PDM_UPAYA_KASASI form base class.
 *
 * @method PDM_UPAYA_KASASI getObject() Returns the current form's model object
 *
 * @package    dnt
 * @subpackage form
 ...
 */
abstract class BasePDM_UPAYA_KASASIForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'isi_memori'          => new sfValidatorString(array('max_length' => 1000, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('pdm_upaya_kasasi[%s]');
