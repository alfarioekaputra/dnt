 ...
 * @property PDM_BARBUK $PDM_BARBUK
 * 
 ...
 * @method PDM_BARBUK        getPDMBARBUK()       Returns the current record's "PDM_BARBUK" value
 ...
 * @method PDM_BARBUK_LELANG setNoBa()            Sets the current record's "no_ba" value
 * @method PDM_BARBUK_LELANG setTglLelang()       Sets the current record's "tgl_lelang" value
 * @method PDM_BARBUK_LELANG setTaksiran()        Sets the current record's "taksiran" value
 * @method PDM_BARBUK_LELANG setNilaiWajar()      Sets the current record's "nilai_wajar" value
 * @method PDM_BARBUK_LELANG setPenyimpanan()     Sets the current record's "penyimpanan" value
 * @method PDM_BARBUK_LELANG setKondisi()         Sets the current record's "kondisi" value
 * @method PDM_BARBUK_LELANG setHambatan()        Sets the current record's "hambatan" value
 * @method PDM_BARBUK_LELANG setUsulan()          Sets the current record's "usulan" value
 * @method PDM_BARBUK_LELANG setPetunjuk()        Sets the current record's "petunjuk" value
 * @method PDM_BARBUK_LELANG setHasilLelang()     Sets the current record's "hasil_lelang" value
 * @method PDM_BARBUK_LELANG setNoBuktiStr()      Sets the current record's "no_bukti_str" value
 * @method PDM_BARBUK_LELANG setTglStr()          Sets the current record's "tgl_str" value
 * @method PDM_BARBUK_LELANG setStatus()          Sets the current record's "status" value
 ...
 * @method PDM_BARBUK_LELANG setPDMBARBUK()       Sets the current record's "PDM_BARBUK" value
 * 
 * @package    dnt
 * @subpackage model
