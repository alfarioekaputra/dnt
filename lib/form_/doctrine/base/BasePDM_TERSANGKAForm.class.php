...
abstract class BasePDM_TERSANGKAForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'jkl'                    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('MS_JNSKELAMIN'), 'add_empty' => true)),
      ...
      'id_agama'               => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('MS_AGAMA'), 'add_empty' => true)),
      'pendidikan'             => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('MS_PENDIDIKAN'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'jkl'                    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('MS_JNSKELAMIN'), 'required' => false)),
      ...
      'id_agama'               => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('MS_AGAMA'), 'required' => false)),
      'pendidikan'             => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('MS_PENDIDIKAN'), 'required' => false)),
