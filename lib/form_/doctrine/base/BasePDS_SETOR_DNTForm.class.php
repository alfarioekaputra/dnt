...
/**
 * PDS_SETOR_DNT form base class.
 *
 * @method PDS_SETOR_DNT getObject() Returns the current form's model object
 *
 * @package    dnt
 * @subpackage form
 ...
 */
abstract class BasePDS_SETOR_DNTForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'up_rupiah'        => new sfWidgetFormInputText(),
      'up_lainnya'       => new sfWidgetFormInputText(),
      'str_pj_biaya'     => new sfWidgetFormInputText(),
      'str_denda'        => new sfWidgetFormInputText(),
      'str_hasil_lelang' => new sfWidgetFormInputText(),
      'str_up_rupiah'    => new sfWidgetFormInputText(),
      'str_up_lainnya'   => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'up_rupiah'        => new sfValidatorNumber(array('required' => false)),
      'up_lainnya'       => new sfValidatorNumber(array('required' => false)),
      ...
      'str_up_rupiah'    => new sfValidatorNumber(array('required' => false)),
      'str_up_lainnya'   => new sfValidatorNumber(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('pds_setor_dnt[%s]');
