 ...
 * @method PDM_BARBUK_LELANG setIdStrDnt()        Sets the current record's "id_str_dnt" value
 ...
 * @method PDM_BARBUK_LELANG setPDMSETORDNT()     Sets the current record's "PDM_SETOR_DNT" value
 * 
 * @package    dnt
 * @subpackage model
