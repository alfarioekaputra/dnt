...
/**
 * PDS_DETAIL_STR form base class.
 *
 * @method PDS_DETAIL_STR getObject() Returns the current form's model object
 *
 * @package    dnt
 * @subpackage form
 ...
 */
abstract class BasePDS_DETAIL_STRForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pds_detail_str[%s]');
