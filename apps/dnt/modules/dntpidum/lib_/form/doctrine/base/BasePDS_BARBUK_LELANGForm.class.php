...
/**
 * PDS_BARBUK_LELANG form base class.
 *
 * @method PDS_BARBUK_LELANG getObject() Returns the current form's model object
 *
 * @package    dnt
 * @subpackage form
 ...
 */
abstract class BasePDS_BARBUK_LELANGForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('pds_barbuk_lelang[%s]');
